...
<div class="container-fluid h-full w-full">
    <div class="signup m-auto col-lg-4 col-md-6 col-sm-8 shadow-sm p-4">
        <form action="" method="post">
            <h1 class="h3">Ajouter utilisateur</h1>
            <div class="mb-3">
                <input type="text" class="form-control" value="<?= get_var('nom') ?>" name="nom" id="nom" placeholder="Nom">
                <?php if (isset($errors['nom'])): ?>
                    <span class="text-danger"><?= $errors['nom'] ?></span>
                <?php endif; ?>
            </div>
            <div class="mb-3">
                <input type="text" class="form-control" value="<?= get_var('prenom') ?>" name="prenom" id="prenom" placeholder="Prenom">
                <?php if (isset($errors['prenom'])): ?>
                    <span class="text-danger"><?= $errors['prenom'] ?></span>
                <?php endif; ?>
            </div>
            <div class="mb-3">
                <input type="email" class="form-control" value="<?= get_var('email') ?>" name="email" id="email" placeholder="Email">
            ...
            <div class="mb-3">
                <select name="genre" id="genre" class="form-control">
                    <option <?= get_select("genre", "") ?> value="">-- SELECT genre --</option>
            ...
            <div class="mb-3">
                <input type="password" class="form-control" value="<?= get_var('password') ?>" name="password" id="password" placeholder="Mot de passe">
            </div>
            <div class="mb-3">
                <input type="password" class="form-control" value="<?= get_var('password2') ?>" name="password2" id="password2" placeholder="Confirmer mot de passe">
